<template>
  ...
  <ul>
      <li v-for="prod in product">{{ $prod }} </li>
  </ul>
    <!--Section: Content-->
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="card">
            ...
            <!-- Card image -->
            <div class="view overlay">
              <img class="card-img-top" src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/shoes%20(7).jpg"
                alt="Card image cap">
              <a href="#!">
                <div class="mask rgba-white-slight"></div>
              </a>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="card">
            ...
            <!-- Card image -->
            <div class="view overlay">
              <img class="card-img-top" src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/shoes%20(8).jpg"
                alt="Card image cap">
              <a href="#!">
                <div class="mask rgba-white-slight"></div>
              </a>
...
<script>
    export default {
        ...
        methods: {
            getProduct(){
                axios.get('showdesign/{{$product->id}}')
                     .then((response)=>{
