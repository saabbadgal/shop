               ...
               {{--              <li class="d-inline-block align-self-center  d-block d-lg-none">
                     ...
                     {{--        <li class="dropdown user-profile align-self-center d-inline-block">
                                <a href="#" class="nav-link py-0" data-toggle="dropdown" aria-expanded="false"> 
                                    <div class="media">                                   
                                        <img src="{{asset('admin/images/author.jpg')}}" alt="" class="d-flex img-fluid rounded-circle" width="29">
                                    </div>
                                </a>
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                        <ul> 
                            ...
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Sliders</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('admin.slider.index')}}"><i class="icon-energy"></i> All Sliders</a></li>
                                    <li><a href="{{route('admin.slider.create')}}"><i class="icon-disc"></i>Create Slider</a></li> 
                                </ul>
                            </li>
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Orders</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('admin.order.index')}}"><i class="icon-energy"></i> All Orders</a></li>
                                    {{-- <li><a href="{{route('admin.slider.create')}}"><i class="icon-disc"></i>Create Slider</a></li>  --}}
                                </ul>
                            </li>
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Website Profile</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('admin.profile.edit')}}"><i class="icon-energy"></i>Edit</a></li>
                                    {{-- <li><a href="{{route('admin.slider.create')}}"><i class="icon-disc"></i>Create Slider</a></li>  --}}
                                </ul>
                            </li>
